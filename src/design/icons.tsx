...
/**
 * Cozy 16-bit pixel sprites — hand-authored ASCII grids on a 16×16
 * canvas. 'X' = full-tone pixel, 'x' = soft-tone pixel (≈55% opacity),
 * '.' = empty. The soft tone reads as a highlight in light mode and a
 * shade in dark mode, so sprites stay currentColor-themed. Icons
 * without a sprite here fall back to their stroke path. `filled`
 * icons render a solid variant; otherwise an outline variant
 * (star, heart) or the single art.
 */
